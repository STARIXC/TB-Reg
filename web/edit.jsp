                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="xray" name="xray">
                                                        <option selected  value="<%=Xray%>"><%=Xray%></option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="hivStatus" name="hivStatus">
                                                        <option selected  value="<%=hivStatus%>"><%=hivStatus%></option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="art" name="art">
                                                        <option selected  value="<%=artstatus%>"><%=artstatus%></option>
                                                        <option value="Y">YES</option>
                                                        <option value="N">NO</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="sputumSmear" name="sputumSmear">
                                                        <option selected  value="<%=smear0%>"><%=smear0%></option>
                                                        <option value="ND">ND</option>
                                                        <option value="Neg">Neg</option>
                                                        <option value="Pos">Pos</option>
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="generalExpert" name="generalExpert">
                                                        <option selected  value="<%=genexpert%>"><%=genexpert%></option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="withinFacility" name="withinFacility">
                                                        <option selected  value="<%=withinfacility%>"><%=withinfacility%></option>
                                                        <option value="Y">YES</option>
                                                        <option value="N">NO</option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="hivModality" name="hivModality">
                                                        <option  selected value="<%=initialmodality%>"><%=initialmodality%></option>
