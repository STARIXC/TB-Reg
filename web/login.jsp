                                ...
                                <div class="col-lg-12">
                                    ...
                                    <form id="register-form" action="EmployeeServlet" method="post" role="form" style="display: none;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="help-block has-error" id="mailexist_err">Email Address already Registered</span>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <span class="help-block has-error" id="usernameexits">Username Already Taken</span>
                                        </div>
